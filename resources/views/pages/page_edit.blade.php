                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea name="note" class="form-control" id="val-note" name="val-note"
                                            rows="5" placeholder="Not Required">{{ $pageDB->note }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control selectric" aria-label="Default select example"
                                            ...
                                            <option value="On Review"
                                                {{ $pageDB->status == 'On Review' ? 'selected' : '' }}>On Review
                                            </option>
                                            <option value="Approved"
                                                {{ $pageDB->status == 'Approved' ? 'selected' : '' }}>
                                                Approved</option>
                                            <option value="Declined"
                                                {{ $pageDB->status == 'Declined' ? 'selected' : '' }}>
                                                Declined</option>
                                        </select>
                                    </div>
                                </div>
