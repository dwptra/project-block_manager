                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('block.update', $blockEdit['id'])}}" method="post">
                                ...
                                <div class="form-group row mb-2">
                                    <label class="col-sm-2"><b>Section Name </b><span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <input type="text" name="section_name" class="form-control"
                                                placeholder="Enter Section Name" value="{{ $blockEdit->section_name}}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <textarea name="note" class="form-control" rows="5" cols="50"
                                                placeholder="Enter Note">{{ $blockEdit->note}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><b>Sort </b><span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <input type="text" name="sort" class="form-control"
                                                placeholder="Enter Section Sort" value="{{ $blockEdit->sort}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div id="accordion">
                                    <div class="accordion">
                                        @foreach ($blockDB->groupBy('categories.category_name') as $categoryName =>
                                        $blocks)
