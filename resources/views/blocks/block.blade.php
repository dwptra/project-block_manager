                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-primary" href="{{ route('block.create', $pageDB->id) }}">Create
                                    Block</a>
                                <a class="btn btn-success ml-1 text-white"
                                    href="{{ route('blocks.print', $pageDB['id'])}}" target="_blank">Export Block List
                                </a>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a class="btn btn-success mr-1" title="Edit"
                                                        href="{{ route('block.edit', $block->id) }}"><i
